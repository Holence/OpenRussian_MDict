...
words = pd.read_csv("openrussian_public/openrussian_public - words.csv", usecols=["id", "bare", "disabled", "type"])
...
words_forms_csv = pd.read_csv("openrussian_public/openrussian_public - words_forms.csv", usecols=["word_id", "form_bare"])
